...
async function groth16ExportStylusVerifier(params, options) {
    ...
    fs.cpSync("templates/groth16_verifier_template", verifierOutput, {recursive: true});
    ...
    const verifierCode = await groth16.exportStylusVerifier(zkeyName, template, logger);

    fs.writeFileSync(verifierOutput+"/src/lib.rs", verifierCode, "utf-8");
